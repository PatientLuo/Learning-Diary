...
![Fig. 1 Three types of scattering of radar signals (Source: Amitrano et al., 2024)](images/flood.png){width="70%"}
...
![Figure 2 Schematic of the Google Earth Engine (Source: Gorelick et al., 2017)](images/Geewk1.png){width="70%"}
